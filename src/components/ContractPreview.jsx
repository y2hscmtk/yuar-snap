                    ...
                    <div className="contract-content">
                        ...
                        <div className="contract-body">
                            ...
                            <ol>
                                ...
                                <li>
                                    <div>보정본은 ‘계약자’가 셀렉사진 전달 날을 기준으로 7일 이내 제공됩니다. 계약자는 촬영일로부터 4주 이내에 셀렉사진을 전달해야 하며, 해당 기한을 초과할 경우 보정은 진행되지 않을 수 있습니다.</div>
                            ...
                            <ol>
                                ...
                                <li>후기 작성 시 사진 5장 이상 및 글 700자 이상으로 작성해야 하며, 후기를 게시하는 모든 플랫폼은 공개 계정이어야 합니다.</li>
                                ...
                                <li>
                                    <div>계약 후기는 계약 체결일로부터 2주 이내에 작성하여야 하며, 작성된 후기는 게시일로부터 6개월 이상 게시 상태로 유지하여야 합니다.</div>
                                    <div>촬영 후기는 본식 촬영일로부터 4주 이내에 작성하여야 하며, 작성된 후기는 게시일로부터 6개월 이상 게시 상태로 유지하여야 합니다.</div>
