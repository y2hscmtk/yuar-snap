                ...
                <div className="contract-paper" id="contract-preview" ref={ref}>
                    ...
                    <div className="contract-content">
                        ...
                        <div className="contract-body">
                            ...
                            <p>아이폰 스냅은 DSLR 촬영과는 다른 자연스럽고 감정 중심의 기록 촬영으로, 촬영 환경(조명, 공간, 예식 진행 등)에 따라 화질 및 색감에 제한이 있을 수 있음을 을은 충분히 인지하고 이에 동의합니다.</p>
                            ...
                            <ol>
                                ...
                                <li>보정본은 ‘계약자’가 셀렉사진 전달 날을 기준으로 7일 이내 제공됩니다.<br></br>(‘계약자’의 사정으로 셀렉이 어려워 ‘유아르스냅’에게 셀렉을 위임한 경우, 보정본 전달 기준일은 본식 촬영일을 기준으로 합니다.)</li>
                                <li>천재지변, 장비 손상, 질병 등 불가항력적인 사유로 전달이 지연될 경우, 갑은 즉시 을에게 이를 고지하며, 가능한 한 빠른 시일 내 결과물을 전달하도록 합니다.</li>
                            ...
                            <ol>
                                ...
                                <li>‘유아르스냅’은 촬영 결과물을 포트폴리오, SNS, 홈페이지 등 홍보 목적으로 사용할 수 있습니다.<br></br>(‘계약자’가 초상권 사용에 대해 비동의를 요청한 경우, 얼굴 식별이 불가능한 모자이크 처리된 사진 또는 뒷모습 사진에 한하여 업로드될 수 있습니다.)</li>
                            </ol>

                            <h3>제 9 조 [면책 조항]</h3>
                            <ol>
                                <li>‘유아르스냅의’ 일방적 취소 또는 사전 고지 없는 당일 노쇼 발생 시, 계약금의 3배를 배상합니다.<br></br>(갑작스러운 질병, 사고, 직계가족의 장례 등 불가피한 사유 발생 시 사전 고지한 경우 계약금은 전액 환불됩니다.)</li>
                                <li>예식장 조명, 공간 제약, 촬영 제한, 장비 오류 등 불가항력적 사유로 인한 일부 결과물의 품질 저하에 대해 갑은 책임을 지지 않습니다.<br></br>(‘유아르스냅’의 명백한 과실이 인정될 경우 상호 협의 하에 일부 환불 또는 이에 상응하는 보상으로 조정할 수 있습니다.)</li>
                            ...
                            <ol>
                                ...
                                <li>짝꿍 할인은 신규 계약자에 한하여 적용되며, 이미 계약이 완료된 계약자 간에는 적용되지 않습니다. <br></br>(예: 신규 계약 희망자 + 계약 완료자 → 적용 가능 / 계약 완료자 + 계약 완료자 → 적용 불가)</li>
                            ...
                            <ol>
                                ...
                                <li>본 계약은 갑과 을의 상호 신뢰를 바탕으로 체결되며, 양 당사자는 성실히 본 계약을 이행합니다.</li>
                            </ol>
                        </div>
